    ...
    public class ServerTileLayer
    {
        ...
        <map:TileLayer x:Key="WorldOsm" SourceName="World OSM WMS"
            ...
            TileLayers = new List<TileLayer>()
            {
                ...
                new TileLayer() {
                    SourceName = "ArcgisImagery",
                    TileSource = new TileSource { UriFormat = "http://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}" },
                    DrawLinesColor = new SolidColorBrush(Colors.Black)
                },
            };
        }
